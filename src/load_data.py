...
SPLIT_ULTRA_RANK = "data/split_ultrafeedback"
...
def get_rank_dataset_file(dataset='hh',split='train',K=8):
    ...
    # /home/mil/MIL201/CC/drpo/samples_vllm/hh-rank-train-K8-deberta-v3.json
    dataset_name = f'{dataset}-rank-{split}-K{K}-deberta-v3.json'
    return os.path.join(HH_RANK_BASE,dataset_name)
    # return f'/home/mil/MIL201/CC/drpo/samples_vllm/{dataset}-rank-test-K{K}-deberta-v3.json'
