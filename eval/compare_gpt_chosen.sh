...
files=(
    ...
    # "/home/mil/MIL201/CC/alignment-handbook/eval/samples/base-sft/qwen1.5-0.5-base-hh-sft.json"
    # "/home/mil/MIL201/CC/alignment-handbook/eval/samples/base-sft/qwen1.5-1.8-base-hh-sft.json"
    # "/home/mil/MIL201/CC/alignment-handbook/eval/samples/main_method_0.5b/qwen1.5-0.5-hf-drpo-pldpo-beta0.1-lr5e-7.json"
    # "/home/mil/MIL201/CC/alignment-handbook/eval/samples/qwen1.5-0.5-exp-K2/qwen1.5-1.8-hf-drpo-btdpo-K2-beta0.1-lr5e-7.json"
    # "samples/btdpo-ablations/qwen1.5-0.5-hf-drpo-k2-btdpo-lr5e-7-ada.json"
    # "samples/btdpo-ablations/qwen1.5-1.8-hf-pirank-tau1.0-lr5e-7-allrank-ada-step.json"
...
result_dir="gpt-results/qwen-drpo-main-noasync-gpt-4o-2024-08-06-ms"
